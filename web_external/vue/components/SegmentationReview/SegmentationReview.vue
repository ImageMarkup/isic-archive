      ...
      template(v-else)
        table.table.table-condensed
          ...
          tr
            ...
            td(v-if='segmentations.length') {{ activeSegmentationIndex + 1 }} of {{ segmentations.length }}
            td(v-else) (none)
...
const { mapState, mapGetters, mapMutations, mapActions } = createNamespacedHelpers('segmentationReview');
...
export default {
    ...
    watch: {
        workflowState(newState, oldState) {
