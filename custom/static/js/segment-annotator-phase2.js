...
SegmentAnnotator.prototype.getAllData = function () {

    var returndata = {
        'indexMap': this.indexMap,
        'rgbData': this.rgbData,
...
SegmentAnnotator.prototype.getCanvasAsPNG = function () {
...
SegmentAnnotator.prototype.getIndicies = function () {
...
SLICSegmentAnnotator = function (canvas_ref, options) {
    var _this = this;
    SLICSegmentation(canvas_ref, {
        regionSize: options.regionSize,
        callback: function (result) {
            SegmentAnnotator.call(_this, result, options);
        }
